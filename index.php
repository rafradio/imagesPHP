...
<html>
    <head>
        ...
        <script src="galleria/galleria-1.5.1.js"></script>
    </head>
    <body>
        <div class="galleria">
            <img id="pic1" src="img/IMG_6418.PNG" data-big="img/berezy.jpg"> 
            <img id="pic2" src="img/repin_krest_hod.jpg" data-big="img/night.png">
            <img id="pic3" src="img/savr.jpg" data-big="img/step.jpg">
        </div>
        ...
        <!-- <script src="galleria/galleria-1.5.1.js"></script> -->
        <!-- <script src="galleria/check.js"></script> -->
</body>
</html>
